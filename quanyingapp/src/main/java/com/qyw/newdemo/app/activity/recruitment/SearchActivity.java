...
import com.qyw.newdemo.app.helper.RecordSQLiteOpenHelper;
import com.qyw.newdemo.app.view.MyListView;
        ...
        et_search.setOnKeyListener(new View.OnKeyListener() {// 输入完后按键盘上的搜索键
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {// 修改回车键功能
                    ...
                    Toast.makeText(SearchActivity.this, "clicked!"+et_search.getText().toString().trim(), Toast.LENGTH_SHORT).show();
