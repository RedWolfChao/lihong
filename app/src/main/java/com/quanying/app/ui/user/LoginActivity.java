...
/*
        ...
        SoftKeyBoardListener.setListener(LoginActivity.this, new SoftKeyBoardListener.OnSoftKeyBoardChangeListener() {
            ...
            public void keyBoardShow(int height) {
                shrinkUi(getResources().getDimensionPixelOffset(R.dimen.uitop));
            }

            @Override
            public void keyBoardHide(int height) {
                shrinkUi(getResources().getDimensionPixelOffset(R.dimen.imgh));
            }
        });
...
/*
    ...
    public void shrinkUi(int h){

        */
/*loginbkg.getLayoutParams().height = getResources().getDimensionPixelOffset(R.dimen.imgh);*//*


        */
/*LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        params.setMargins(0, getResources().getDimensionPixelOffset(R.dimen.uitop), 0, 0);
        newlogin_head_ui.setLayoutParams(params);
        *//*

*/
/*
        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) newlogin_head_ui.getLayoutParams();
        lp.topMargin = getResources().getDimensionPixelOffset(R.dimen.uitop);
        newlogin_head_ui.setLayoutParams(lp);*//*
        ...
        params =
                (RelativeLayout.LayoutParams)newlogin_head_ui.getLayoutParams();
        params.setMargins(0, h, 0, 0);//left,top,right,bottom
        newlogin_head_ui.setLayoutParams(params);
