                        ...
                        if(code.equals("200")){
                            ...
                            ts_button.setOnClickListener(new View.OnClickListener() {
                                @Override public void onClick(View v) {
                                    startActivity(new Intent(DbUIActivity.this,LoginActivity.class));
                                }
                            });
                            ...
                            ts_button.setOnClickListener(new View.OnClickListener() {
                                @Override public void onClick(View v) {
                                    ...
                                    Intent intent = new Intent(DbUIActivity.this,WebActivity.class);
                                    intent.putExtra("title","title");
                                    intent.putExtra("urls",playUrl);
            ...
            @Override public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(TextUtils.isEmpty(text_)){
                   ...
                   return false;
                    ...
                    Log.e("lalal",MyApplication.PLAYCID);
                    Log.e("lalalCookie",MyApplication.Cookies+"");
                ...
                OkHttpUtils
                    ...
                    .addParams("infoid", MyApplication.PLAYCALLBACKID)
...
//                            getScore();
                            AlertDialog.Builder builder = new AlertDialog.Builder(DbUIActivity.this);
                            //    设置Title的图标
...
//                                    Toast.makeText(MainActivity.this, "positive: " + which, Toast.LENGTH_SHORT).show();
                            ...
                            //    设置一个NegativeButton
                            builder.setNegativeButton("立即充值", new DialogInterface.OnClickListener()
                            {
                                @Override
                                public void onClick(DialogInterface dialog, int which)
                                {
//                                    Toast.makeText(MainActivity.this, "negative: " + which, Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(DbUIActivity.this,WebActivity.class);
                                    intent.putExtra("title","title");
                                    intent.putExtra("urls","http://m.7192.com/appzbcz.html");
                                    startActivity(intent);
                                }
                            });
