...
public class PlayUINewActivity extends FragmentActivity implements View.OnClickListener{
    ...
    * */
    ...
    private void initYanhua(){
        ...
        mImageView = (ImageView)findViewById(R.id.danmustart);
        mList = new ArrayList<>();
        ...
        db_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PlayUINewActivity.this, "zule", Toast.LENGTH_SHORT).show();
...
//                danmakuEntity.set("setName");
    ...
    @BindViews({
        R.id.recorf_seekbar, R.id.luminance_seekbar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_ui_new);
    ...
    protected void onResume() {
        ...
        super.onResume();
        startListener();
        AppKeyBoardMgr.closeKeybord(send,PlayUINewActivity.this);
        MyApplication.PLAYSTATUS = "1";
        if (onClickOrientationListener != null) {
                        ...
                        if(code.equals("200")){
                            ...
                            ts_button.setOnClickListener(new View.OnClickListener() {
                                @Override public void onClick(View v) {
                                    startActivity(new Intent(PlayUINewActivity.this,LoginActivity.class));
                                }
                            });
                                            ...
                                            @Override public void onResponse(String response, int id) {
                                                ...
                                                try {
                                                    ...
                                                    if(code.equals("200")){
                                                        play_ui_ts.setVisibility(View.GONE);
                                                        String errmsg = jsonObject.getString("errmsg");
                                                        Toast.makeText(PlayUINewActivity.this, ""+errmsg, Toast.LENGTH_SHORT).show();
                            ...
                            ts_button.setOnClickListener(new View.OnClickListener() {
                                @Override public void onClick(View v) {
                                    startActivity(new Intent(PlayUINewActivity.this,PayPlayWebActivity.class));
                                }
                            });
                        }else{
                            play_ui_ts.setVisibility(View.VISIBLE);
    ...
    private void initControls() {
        ...
        fAdapter = new PlayAdapter(PlayUINewActivity.this.getSupportFragmentManager(),list_fragment,list_title);
        //viewpager加载adapter
    ...
    private void sendMeg() {
        ...
        if(TextUtils.isEmpty(text_)){
            Toast.makeText(PlayUINewActivity.this, "输入内容为空", Toast.LENGTH_SHORT).show();
                    ...
                    @Override public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if(errcode.equals("200")){
                                ...
                                Toast.makeText(PlayUINewActivity.this,""+msg,Toast.LENGTH_SHORT).show();
                                AppKeyBoardMgr.closeKeybord(send,PlayUINewActivity.this);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
...
//      初始化一下竖屏操作
    ...
    private void initVodPlayer() {
        ...
        mPlayer = new AliVcMediaPlayer(PlayUINewActivity.this, mSurfaceView);
            ...
            .execute(new StringCallback() {
                ...
                @Override public void onResponse(String response, int id) {
                    ...
                    try {
                        ...
                        if(errcode.equals("200")){
                            String errmsg = jsonObject.getString("errmsg");
                            Toast.makeText(PlayUINewActivity.this,""+errmsg,Toast.LENGTH_LONG).show();
                            getScore();
                        }else{
                            String errmsg = jsonObject.getString("errmsg");
                            Toast.makeText(PlayUINewActivity.this,""+errmsg,Toast.LENGTH_LONG).show();
