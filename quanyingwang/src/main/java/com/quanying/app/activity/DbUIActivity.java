...
import com.quanying.app.adapter.GridViewAdapter;
import com.quanying.app.adapter.LwListAdapter;
import com.quanying.app.adapter.PlayAdapter;
import com.quanying.app.bean.AnyEventType;
import com.quanying.app.bean.GridItem;
import com.quanying.app.bean.GridListItem;
import com.quanying.app.fragment.CallBackFragment;
import com.quanying.app.fragment.ChatFragment;
import com.quanying.app.fragment.ParticularsFragment;
import com.quanying.app.oper.OnClickOrientationListener;
import com.quanying.app.utils.AppKeyBoardMgr;
import com.quanying.app.utils.Formatter;
...
public class DbUIActivity extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_db_ui);
    ...
    @Override protected void onResume() {
        ...
        AppKeyBoardMgr.closeKeybord(send,DbUIActivity.this);
        initOper();
        initVodPlayer();
        //礼物列表
        //initGift();
    ...
    private void initPlayUI() {
        ...
        Log.e("initdb",MyApplication.Cookies);
        OkHttpUtils
            .post()
                        ...
                        if(code.equals("200")){
                            ...
                            ts_button.setOnClickListener(new View.OnClickListener() {
                                @Override public void onClick(View v) {
                                    startActivity(new Intent(DbUIActivity.this,LoginWebActivity.class));
                                }
                            });
                            ...
                            ts_button.setOnClickListener(new View.OnClickListener() {
                                @Override public void onClick(View v) {
                                    startActivity(new Intent(DbUIActivity.this,PayPlayWebActivity.class));
                                }
                            });
                        }else{
                            play_ui_ts.setVisibility(View.VISIBLE);
                ...
                @Override public void onResponse(String response, int id) {
                    ...
                    try {
                        ...
                        if(errcode.equals("200")){
                            ...
                            mGridViewAdapter = new GridViewAdapter(DbUIActivity.this,0, mGridData,mGridView);
                            lwAdapter = new LwListAdapter(DbUIActivity.this,0, mListData,mGridView);
    ...
    private void initControls() {
        ...
        fAdapter = new PlayAdapter(DbUIActivity.this.getSupportFragmentManager(),list_fragment,list_title);
        //viewpager加载adapter
        ...
        send.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(TextUtils.isEmpty(text_)){
                    Toast.makeText(DbUIActivity.this, "输入内容为空", Toast.LENGTH_SHORT).show();
                   return false;
                }else{
                    params = new HashMap<String,String>();
                    params.put( "Cookie",MyApplication.Cookies);
...
//      初始化一下竖屏操作
    ...
    private void initVodPlayer() {
        ...
        mPlayer.setErrorListener(new MediaPlayer.MediaPlayerErrorListener() {
            ...
            public void onError(int i, String msg) {
                ...
                ts_title.setText(errmsg);
                ts_button.setVisibility(View.GONE);
                Toast.makeText(DbUIActivity.this.getApplicationContext(), "视频出错", Toast.LENGTH_SHORT).show();
                mPlayer.stop();
    ...
    private static class MyFrameInfoListener implements MediaPlayer.MediaPlayerFrameInfoListener {
        ...
        private WeakReference<DbUIActivity> vodModeActivityWeakReference;

        public MyFrameInfoListener(DbUIActivity vodModeActivity) {
            vodModeActivityWeakReference = new WeakReference<DbUIActivity>(vodModeActivity);
        }

        @Override
        public void onFrameInfoListener() {
            DbUIActivity vodModeActivity = vodModeActivityWeakReference.get();
            ...
            .execute(new StringCallback() {
                ...
                @Override public void onResponse(String response, int id) {
                    ...
                    try {
                        ...
                        if(errcode.equals("200")){
                            String errmsg = jsonObject.getString("errmsg");
                            Toast.makeText(DbUIActivity.this,""+errmsg,Toast.LENGTH_LONG).show();
                            getScore();
                        }else{
                            String errmsg = jsonObject.getString("errmsg");
                            Toast.makeText(DbUIActivity.this,""+errmsg,Toast.LENGTH_LONG).show();
