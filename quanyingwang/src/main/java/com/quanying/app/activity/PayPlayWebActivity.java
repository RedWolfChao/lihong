...
public class PayPlayWebActivity extends FragmentActivity {
  ...
  private void initWebView() {
    ...
    CookieSyncManager.createInstance(PayPlayWebActivity.this);
  ...
  class JSInterface {
    ...
    public void aliPay(String orderJson) {
      ...
      try {
        AlipayUtil.doPay(PayPlayWebActivity.this, handler, orderJson);
      } catch (Exception e) {
        // TODO Auto-generated catch block
        e.printStackTrace();
        Toast.makeText(PayPlayWebActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
    ...
    public void wxPay(String orderJson) {
      Log.e("kanknapay",orderJson);
      WXPayUtil.doPay(PayPlayWebActivity.this, orderJson);
    }
    @JavascriptInterface
      ...
      switch (msg.what) {
        case AlipayUtil.SDK_PAY_FLAG: {
          ...
          if (TextUtils.equals(resultStatus, "9000")) {
            Toast.makeText(PayPlayWebActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
            ...
            if (TextUtils.equals(resultStatus, "8000")) {
              Toast.makeText(PayPlayWebActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();
