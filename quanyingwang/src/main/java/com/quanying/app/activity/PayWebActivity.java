...
public class PayWebActivity extends FragmentActivity {
  ...
  private void initWebView() {
    ...
    CookieSyncManager.createInstance(PayWebActivity.this);
  ...
  class JSInterface {
    ...
    public void aliPay(String orderJson) {
      ...
      try {
        AlipayUtil.doPay(PayWebActivity.this, handler, orderJson);
      } catch (Exception e) {
        // TODO Auto-generated catch block
        e.printStackTrace();
        Toast.makeText(PayWebActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
    ...
    public void wxPay(String orderJson) {
      Log.e("kanknapay",orderJson);
      WXPayUtil.doPay(PayWebActivity.this, orderJson);
    }
    @JavascriptInterface
      ...
      switch (msg.what) {
        case AlipayUtil.SDK_PAY_FLAG: {
          ...
          if (TextUtils.equals(resultStatus, "9000")) {
            Toast.makeText(PayWebActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
            ...
            if (TextUtils.equals(resultStatus, "8000")) {
              Toast.makeText(PayWebActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();
